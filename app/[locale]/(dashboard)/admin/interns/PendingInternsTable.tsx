        ...
        return (
            <MetalCard>
                <div className="flex flex-col items-center justify-center py-16 text-slate-400">
                    ...
                    <p className="mt-2">{t("admin.interns.pendingLoadError")}</p>
                </div>
            </MetalCard>
        );
    }
        ...
        return (
            <MetalCard>
                <div className="flex flex-col items-center justify-center py-16 text-slate-400">
                    ...
                    <p className="mt-2 text-sm">{t("admin.interns.noPending")}</p>
                </div>
            </MetalCard>
        );
    }
                    ...
                    <table className="w-full text-left text-sm">
                        <thead>
                            <tr className="border-b border-white/10 text-xs uppercase text-slate-400">
                                <th className="px-6 py-4 font-medium">{t("admin.interns.colCandidate")}</th>
                                <th className="px-6 py-4 font-medium">{t("admin.interns.colEmail")}</th>
                                <th className="px-6 py-4 font-medium">{t("admin.interns.colDepartment")}</th>
                                <th className="px-6 py-4 font-medium">{t("admin.interns.colPosition")}</th>
                                <th className="px-6 py-4 font-medium">{t("admin.interns.colSubmitted")}</th>
                                <th className="px-6 py-4 font-medium text-right">{t("admin.interns.colActions")}</th>
                            </tr>
                        </thead>
    ...
    return (
        <div className="px-2 py-8 text-center">
            ...
            <div className="mt-6 flex justify-center gap-3">
                ...
                >
                    {action === "APPROVED" ? t("admin.interns.approve") : t("admin.interns.reject")}
                </button>
            </div>
        </div>
    );
