...
export default function MeetingStats() {
  ...
  const cards = [
    { title: t("admin.meetings.totalMeetings"), value: totalData?.meta?.total ?? 0, icon: Calendar, iconBg: "from-sky-500/20 to-cyan-400/10" },
    { title: t("admin.meetings.scheduled"), value: scheduledData?.meta?.total ?? 0, icon: Clock, iconBg: "from-blue-500/20 to-indigo-400/10" },
    { title: t("admin.meetings.completed"), value: completedData?.meta?.total ?? 0, icon: CheckCircle2, iconBg: "from-violet-500/20 to-purple-400/10" },
    { title: t("admin.meetings.cancelled"), value: cancelledData?.meta?.total ?? 0, icon: XCircle, iconBg: "from-red-500/20 to-rose-400/10" },
  ];
