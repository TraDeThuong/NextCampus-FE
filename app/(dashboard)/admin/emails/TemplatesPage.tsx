...
export default function TemplatesPage() {
  ...
  // Find the DB record for the selected type (may be null if not seeded yet)
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="mt-0.5 text-sm text-slate-500">
                  {mode === "templates"
                    ? "Configure the title and content for each system notification event."
                    : "Send direct custom notifications and emails to company users."}
                </p>
              </div>
            </div>
