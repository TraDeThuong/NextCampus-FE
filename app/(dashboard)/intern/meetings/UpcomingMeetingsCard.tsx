            ...
            {meetings.map((m) => {
              ...
              const rsvpBadge = myParticipant
                ? myParticipant.invitationStatus === "ACCEPTED"
                  ? { text: t("accepted"), cls: "bg-emerald-500/15 border-emerald-500/30 text-emerald-300" }
                  : myParticipant.invitationStatus === "DECLINED"
                  ? { text: t("declined"), cls: "bg-rose-500/15 border-rose-500/30 text-rose-300" }
                  : { text: t("pending"), cls: "bg-amber-500/15 border-amber-500/30 text-amber-300" }
                : null;
