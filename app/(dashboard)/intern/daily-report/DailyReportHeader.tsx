      ...
      <div className="rounded-3xl p-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-2xl font-bold metal-text">Daily Report</h2>
              <p className="mt-1 text-sm text-slate-500">
                View your internship calendar and daily reports.
              </p>
            </div>
          </div>
          ...
          <div>
            {isPending ? (
              <Button variant="metal-silver" size="md" isLoading disabled></Button>
            ) : hasReportedToday ? (
              <Button
                variant="metal-blue"
                size="md"
