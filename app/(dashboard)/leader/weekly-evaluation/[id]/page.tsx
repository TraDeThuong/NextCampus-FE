...
import { ArrowLeft, Sparkles, User, Calendar, BookOpen, Star, MessageSquare, ClipboardList, Info } from "lucide-react";
          ...
          {(() => {
            ...
            return (
              <div className="flex justify-end px-4 py-2.5 bg-white/[0.02] border-t border-white/5">
                <span className="text-xs text-slate-400 mr-2">{t("sectionScore", { id: section.id })}</span>
